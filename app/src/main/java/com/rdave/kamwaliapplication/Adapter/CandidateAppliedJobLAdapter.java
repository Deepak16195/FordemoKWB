...
import com.rdave.kamwaliapplication.Model.CandiateAppliedjobModel;
import com.rdave.kamwaliapplication.R;

import java.util.List;

public class CandidateAppliedJobLAdapter extends RecyclerView.Adapter<CandidateAppliedJobLAdapter.JLholder> {

    Context jLContext;
    private List<CandiateAppliedjobModel.Data> jLDatta;
    String Logined = "0";
    String LoginedAs = "0";
    String Username = "0";
    String Useremail = "0";
    ...
    public CandidateAppliedJobLAdapter(Context jLContext, List<CandiateAppliedjobModel.Data> jLDatta) {
    ...
    public void onBindViewHolder(@NonNull JLholder jLholder, final int position) {
        ...
        jLholder.jlName.setText(jLDatta.get(position).getEmployerName()+"");
        jLholder.jl_mobileno.setText(jLDatta.get(position).getMobileNo()+"");
        jLholder.jl_SubCate.setText("");
