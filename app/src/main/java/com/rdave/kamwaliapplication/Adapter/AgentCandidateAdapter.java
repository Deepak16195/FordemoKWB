...
import com.rdave.kamwaliapplication.Activity.CProfileActivity;
...
public class AgentCandidateAdapter extends RecyclerView.Adapter<AgentCandidateAdapter.Hholder> {
    ...
    public AgentCandidateAdapter(Context context, List<Candidate.DataBean> datta) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final Hholder hholder, final int position) {
       ...
       // hholder.hImage.setImageResource(datta.get(position).getImage());
        ...
        hholder.btnView.setText("View Profile");
            ...
            public void onClick(View v) {
                ...
                if(Logined.equalsIgnoreCase("1"))
                {
                    if (LoginedAs.equalsIgnoreCase("Agent")) {
                        Intent intent = new Intent (v.getContext(), CProfileActivity.class);
                        intent.putExtra("From","Agent");
                        intent.putExtra("Action","Update");
                        intent.putExtra("Pos", hholder.getAdapterPosition()+"");
